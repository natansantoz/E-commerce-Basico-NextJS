...
/**
 * Realiza a busca dos produtos em destaque na API fake 
 * da camada Node
 */
...
export default async function Home() {
  ...
  // separando o produto cuja foto terá o maior tamanho na home dos demais
  const [hilightedProduct, ...otherProducts] = await getFeaturedProducts();

  return (
    <div className="grid max-h-[860px] grid-cols-9 grid-rows-6 gap-6">
      <Link
        href={`/product/${hilightedProduct.slug}`}
